...
We use the NFL Play-by-Play dataset (2009-2016) from Kaggle \cite{kaggle_pbp}, which contains 362,447 individual plays with player identifiers, game context, and outcome statistics. The dataset includes all regular season and playoff games across eight seasons.
...
Wide receivers and tight ends show the lowest prediction error (MAE=2.02 points) and highest explained variance (R²=0.77). This is likely due to their more consistent week-to-week target shares and usage patterns within offensive schemes.
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{../artifacts/visuals/feature_importance_gb.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{../artifacts/visuals/pred_vs_actual_scatter.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{../artifacts/visuals/baseline_vs_models_mae.png}}
...
Fig. \ref{fig:player_examples} shows weekly time-series for these players. The model tracks sustained performance trends reasonably well but struggles with week-to-week volatility and extreme outcomes.

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{../artifacts/visuals/player_arodgers_pred_vs_actual.png}}
\caption{Aaron Rodgers weekly predictions vs. actual. Model MAE: 6.55 points.}
\label{fig:player_examples}
\end{figure}
